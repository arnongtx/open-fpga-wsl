...
CPP_FUNC_CODE="// -----------------------------------------------------------------------------
// Generated by: open-fpga-wsl (setup.sh)
// Project: VHPIDirect C++ Integration Link
// License: MIT (SPDX-License-Identifier: MIT)
// Copyright: (c) 2026 Arnon (arnongtx)
// -----------------------------------------------------------------------------
#include <iostream>
...
VHDL_CODE="--------------------------------------------------------------------------------
-- Generated by: open-fpga-wsl (setup.sh)
-- Project: VHPIDirect Example Template
-- License: MIT (SPDX-License-Identifier: MIT)
-- Copyright: (c) 2026 Arnon (arnongtx)
--------------------------------------------------------------------------------
library ieee;
...
# ------------------------------------------------------------------------------
# Generated by: open-fpga-wsl (setup.sh)
# Project: FPGA Pin Constraints Template
# License: MIT (SPDX-License-Identifier: MIT)
# Copyright: (c) 2026 Arnon (arnongtx)
# ------------------------------------------------------------------------------
set_io clk 35 
